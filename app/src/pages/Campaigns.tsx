...
const SAMPLE_CAMPAIGNS = [
  {
    id: 1,
    title: "Organic Store in Bandra West",
    description: "We need a dedicated organic grocery store near Hill Road. Currently traveling 5km for basic organic staples.",
    requestType: "new_store" as const,
    category: "Organic Foods",
    targetSignatures: 100,
    currentSignatures: 73,
    status: "active" as const,
  },
  {
    id: 2,
    title: "Pet Supplies in Andheri East",
    description: "No pet store within 3km radius. Need premium pet food and accessories locally.",
    requestType: "new_store" as const,
    category: "Pet Supplies",
    targetSignatures: 75,
    currentSignatures: 68,
    status: "active" as const,
  },
  {
    id: 3,
    title: "Almond Milk & Dairy Alternatives",
    description: "Multiple families looking for almond milk, oat milk, and vegan cheese options in the neighborhood.",
    requestType: "product_category" as const,
  ...
  {
    id: 4,
    title: "Dove & Premium Personal Care",
    description: "Local kirana stores don't stock premium personal care brands. Need better selection.",
    requestType: "brand" as const,
    category: "Personal Care",
    targetSignatures: 40,
    currentSignatures: 28,
    status: "active" as const,
  },
  {
    id: 5,
    title: "Health Food Section",
    description: "Requesting dedicated health food section with quinoa, chia seeds, and protein supplements.",
    requestType: "product_category" as const,
    category: "Health Foods",
    targetSignatures: 60,
    currentSignatures: 55,
    status: "active" as const,
  },
  {
    id: 6,
    title: "Stationery & Office Supplies Store",
    description: "Students and professionals need a nearby store for quality stationery and printing services.",
    requestType: "new_store" as const,
    category: "Stationery",
    targetSignatures: 80,
...
export default function Campaigns() {
  ...
  const allCampaigns = campaigns && campaigns.length > 0 ? campaigns : SAMPLE_CAMPAIGNS;
            ...
            {allCampaigns.map((campaign: any) => {
              ...
              return (
                <div key={campaign.id} className="shutter-card hover:shadow-md transition-shadow">
                  ...
                  <button className="w-full py-2.5 rounded-full bg-[#f8f7f4] text-[13px] font-medium text-[#474645] hover:bg-[#121212] hover:text-white transition-colors flex items-center justify-center gap-1.5">
